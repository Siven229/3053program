...
Aprogram3053Projectile::Aprogram3053Projectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &Aprogram3053Projectile::OnHit);		// set up a notification for when this component hits something
