...
#include "program3053/ActorHP.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeActorHP() {}
// Cross Module References
	PROGRAM3053_API UClass* Z_Construct_UClass_AActorHP_NoRegister();
...
// End Cross Module References
	void AActorHP::StaticRegisterNativesAActorHP()
	{
	}
	UClass* Z_Construct_UClass_AActorHP_NoRegister()
	{
		return AActorHP::StaticClass();
	}
	struct Z_Construct_UClass_AActorHP_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_AActorHP_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AActor,
		(UObject* (*)())Z_Construct_UPackage__Script_program3053,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AActorHP_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ActorHP.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AActorHP_Statics::NewProp_SphereComp = { "SphereComp", nullptr, (EPropertyFlags)0x00200800000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AActorHP, SphereComp), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AActorHP_Statics::NewProp_SphereComp_MetaData, ARRAY_COUNT(Z_Construct_UClass_AActorHP_Statics::NewProp_SphereComp_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AActorHP_Statics::NewProp_MeshComp_MetaData[] = {
		{ "Category", "Components" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ActorHP.h" },
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_AActorHP_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AActorHP>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AActorHP_Statics::ClassParams = {
		&AActorHP::StaticClass,
		nullptr,
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_AActorHP_Statics::PropPointers,
		nullptr,
		ARRAY_COUNT(DependentSingletons),
		0,
		ARRAY_COUNT(Z_Construct_UClass_AActorHP_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AActorHP_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AActorHP_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_AActorHP()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AActorHP_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AActorHP(Z_Construct_UClass_AActorHP, &AActorHP::StaticClass, TEXT("/Script/program3053"), TEXT("AActorHP"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(AActorHP);
